...
// Deploys a Rule Proxy
let deployTarget = (resource) => {
  logger.status("Putting Target Rule")
  let target = {
    Rule: resource.CloudwatchEvents.Name,
    Arn: resource.lambdaFunction.FunctionArn,
    Id: resource.lambdaFunction.FunctionName,
  }
